...
<a href="/docs/quick-start" className="rounded-full bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white no-underline transition hover:opacity-90">Get started</a>
<a href="/docs/how-gecko-works" className="rounded-full border border-gray-200 px-5 py-2.5 text-sm font-semibold no-underline transition hover:bg-gray-100 dark:border-white/15 dark:hover:bg-white/5">How it works</a>
</div>
</div>
